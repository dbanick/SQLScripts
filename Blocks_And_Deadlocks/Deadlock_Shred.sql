...
--------https://social.technet.microsoft.com/Forums/windows/en-US/6e29b938-0b62-4a3f-b52e-85e39233b85b/shredding-deadlock-information-from-xml-data?forum=sqldatabaseengine
-- REFERENCES:
...
FROM    cte2
        CROSS APPLY sys.fn_xe_file_target_read_file('C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\Log\system_health*.xel', NULL, NULL, NULL) t2
...
SELECT  p.DeadlockID,
        ...
        p.BatchStarted,
        p.BatchCompleted,
        REPLACE ( REPLACE (p.QueryStatement, CHAR(13) , '' ) , CHAR(10) , ' ' ) ,
        p.InputBuffer,
        p.DeadlockGraph,
        p.ExecutionStack
FROM    Process p
