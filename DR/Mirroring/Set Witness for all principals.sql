--This script sets a witness for the database mirroring session 
...
BEGIN  
   ---Run the ALTER DATABASE databaseName SET WITNESS 
   SET @strSQL = 'ALTER DATABASE ' + @strDatabaseName + ' SET WITNESS = ''TCP://SYSLOG01.big.ad.local:5022'' '  
