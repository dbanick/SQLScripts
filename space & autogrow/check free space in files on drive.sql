		...
		insert into #db_Files2 select rtrim(@dbname), Filegroup, rtrim(name), filename,cast(SUBSTRING(Size,0,LEN(Size)-2) as int), MaxSize, Growth from #db_Files1
		...
		DEALLOCATE dbcursor
		  ...
		  select b.Database_Name,b.Filegroup,b.Logical_Name,b.Size/1024 as [Size_mb],a.used_mb, (b.Size/1024)-a.used_mb as [FreeSpace_MB],a.percent_used,b.MaxSize,b.Growth,a.autogrow,a.growth_check,b.filename 
		  
		  from ##db_space_info a, #db_Files2 b 
		  where b.Database_Name = a.dbname and b.Filegroup = a.fgname and b.Logical_Name = a.lname
--		  and b.filename like 'I:\%'
		  order by 1,2,3
