--This creates a SP that will help you generate MERGE statements for syncing data
...
(
 ...
 @debug_mode bit = 1, -- If @debug_mode is set to 1, the SQL statements constructed by this procedure will be printed for later examination
